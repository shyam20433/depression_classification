...
joblib.dump(le, 'ss/label_encoder.pkl')
...
joblib.dump(vectorizer, 'ss/tfidf.pkl')
...
joblib.dump(RandomForest, "ss/random_forest.pkl")
...
joblib.dump(xgb_model, "ss/xgboost.pkl")
print("Saved XGBoost")


lr_model = LogisticRegression(max_iter=1000, random_state=42)
lr_model.fit(X_train, y_train)
joblib.dump(lr_model, "ss/logistic_regression.pkl")
...
with open("ss/lightgbm.pkl", "wb") as f:
...
tf_model.save("ss/tf_model.keras")
